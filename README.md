...
<dl>
    ...
    <dd>redirects to project page</dd>

    <dt><code>/&lt;project>?ref=&lt;ref></code>
    <dd>redirects to latest build of <code>ref</code></dd>

    <dt><code>/&lt;project>/build</code></dt>
    <dd>triggers a build, depending on payload</dd>

    <dt><code>/&lt;project>/status.png?ref=&lt;ref></code>
    <dd>returns status icon if the latest build of <code>ref</code></dd>

    <dt><code>/&lt;project>/commits/&lt;sha1></code></dt>
    <dt><code>/&lt;project>/refs/&lt;ref>/commits/&lt;sha1></code> (GitLab 7.10+)</dt>
    <dd>redirects to latest build of revision <code>sha1</code></dd>

    <dt><code>/&lt;project>/commits/&lt;sha1>/status.json</code></dt>
    <dt><code>/&lt;project>/refs/&lt;ref>/commits/&lt;sha1>/status.json</code> (GitLab 7.10+)</dt>
    <dd>returns json with information about latest build of revision <code>sha1</code></dd>
</dl>

Project url `<project>` is generated by jenkins but is generally in form of:
`https://<your-jenkins-host>/gitlab-ci/job/<job name>`.

Note that some urls require authorization in form of `token=<token>` query parameter.
